...
/assign_3`,
		...
		{
			Alexandrov,
			"/new Негативный сценарий",
			map[int64]string{
				Alexandrov: `Задача "Негативный сценарий" создана, id=4`,
			},
		},
		{
			Alexandrov,
			"/tasks",
			map[int64]string{
				Alexandrov: `2. сделать ДЗ по курсу by @ppetrov
assignee: @ppetrov

3. прийти на хакатон by @ivanov
/assign_3

4. Негативный сценарий by @aalexandrov
/assign_4`,
			},
		},
		{
			...
			"/assign_3",
			map[int64]string{
				Ivanov: `Задача "прийти на хакатон" назначена на @aalexandrov`,
				Alexandrov: `Задача "прийти на хакатон" назначена на вас`,
			},
		},
		{
			Alexandrov,
			"/my",
			map[int64]string{
				Alexandrov: `3. прийти на хакатон by @ivanov
/unassign_3 /resolve_3`,
			},
		},
		{
			Ivanov,
		...
		},
		{
			...
			"/tasks",
			map[int64]string{
				Ivanov: `2. сделать ДЗ по курсу by @ppetrov
assignee: @ppetrov
...
/assign_4`,
		...
		},
		{
			...
			"/resolve_3",
			map[int64]string{
				Ivanov: `Задача "прийти на хакатон" выполнена @aalexandrov`,
				Alexandrov: `Задача "прийти на хакатон" выполнена`,
			},
		},
		{
			Alexandrov,
