...
func (c *adminClient) Logging(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (Admin_LoggingClient, error) {
	stream, err := c.cc.NewStream(ctx, &Admin_ServiceDesc.Streams[0], "/service.Admin/Logging", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *adminClient) Statistics(ctx context.Context, in *StatInterval, opts ...grpc.CallOption) (Admin_StatisticsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Admin_ServiceDesc.Streams[1], "/service.Admin/Statistics", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *bizClient) Check(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
	err := c.cc.Invoke(ctx, "/service.Biz/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bizClient) Add(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
	err := c.cc.Invoke(ctx, "/service.Biz/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bizClient) Test(ctx context.Context, in *Nothing, opts ...grpc.CallOption) (*Nothing, error) {
	out := new(Nothing)
	err := c.cc.Invoke(ctx, "/service.Biz/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
